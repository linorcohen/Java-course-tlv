...
public class BigramModelTester {
	public static final String ALL_YOU_NEED_FILENAME = "src/Exercises/ex5/assests/all_you_need.txt";
	public static final String EMMA_FILENAME = "src/Exercises/ex5/assests/emma.txt";
	public static final String ALL_YOU_NEED_MODEL_DIR = "src/Exercises/ex5/assests/all_you_need_model";
...
//		System.out.println(Arrays.toString(sG.mBigramCounts));
